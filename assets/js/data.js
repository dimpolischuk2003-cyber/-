...
window.VSEODENT_DATA = {
  ...
  /* --- 7. РОЗКЛАД -------------------------------------------
     price    — число в грн або null
     bpr      — кількість балів або null
     address  — адреса локації або ''
     time     — '10:00 — 18:00' або ''
     includes — що входить у вартість, тільки підтверджене */
  courses: [
    { slug:'endo-if-2026-09-12',                  date:'12.09.2026', city:'Івано-Франківськ', title:'Ендодонтія. Сучасні протоколи',   topic:'endo',        speaker:'noienko',    template:'primaryEndo',        price:null, bpr:null, address:'', time:'', seats:null, includes:[] },
    { slug:'power-endo-ternopil-2026-09-26',      date:'26.09.2026', city:'Тернопіль',        title:'Power Endo',                      topic:'powerEndo',   speaker:'fedak',      template:'powerEndo',          price:null, bpr:null, address:'', time:'', seats:null, includes:[] },
    { slug:'hygiene-lviv-2026-09-27',             date:'27.09.2026', city:'Львів',            title:'Професійна гігієна від А до Я',   topic:'hygiene',     speaker:'tarasovska', template:'hygiene',            price:null, bpr:null, address:'', time:'', seats:null, includes:[] },
    { slug:'endo-bila-tserkva-2026-10-03',        date:'03.10.2026', city:'Біла Церква',      title:'Ендодонтія. Сучасні протоколи',   topic:'endo',        speaker:'noienko',    template:'primaryEndo',        price:null, bpr:null, address:'', time:'', seats:null, includes:[] },
    { slug:'endo-lviv-2026-10-17',                date:'17.10.2026', city:'Львів',            title:'Ендодонтія. Сучасні протоколи',   topic:'endo',        speaker:'noienko',    template:'primaryEndo',        price:null, bpr:null, address:'', time:'', seats:null, includes:[] },
    { slug:'complex-endo-lviv-2026-10-18',        date:'18.10.2026', city:'Львів',            title:'Складна ендодонтія',              topic:'complexEndo', speaker:'noienko',    template:'complexEndo',        price:null, bpr:null, address:'', time:'', seats:null, includes:[] },
    { slug:'power-endo-rivne-2026-10-24',         date:'24.10.2026', city:'Рівне',            title:'Power Endo',                      topic:'powerEndo',   speaker:'fedak',      template:'powerEndo',          price:null, bpr:null, address:'', time:'', seats:null, includes:[] },
    { slug:'endo-kyiv-2026-11-14',                date:'14.11.2026', city:'Київ',             title:'Ендодонтія. Сучасні протоколи',   topic:'endo',        speaker:'noienko',    template:'primaryEndo',        price:null, bpr:null, address:'', time:'', seats:null, includes:[] },
    { slug:'complex-endo-kyiv-2026-11-15',        date:'15.11.2026', city:'Київ',             title:'Складна ендодонтія',              topic:'complexEndo', speaker:'noienko',    template:'complexEndo',        price:null, bpr:null, address:'', time:'', seats:null, includes:[] },
    { slug:'retreatment-lecture-kyiv-2026-11-28', date:'28.11.2026', city:'Київ',             title:'Переліковування. Лекційний день', topic:'retreatment', speaker:'noienko',    template:'retreatmentLecture', price:null, bpr:null, address:'', time:'', seats:null, includes:[] },
    { slug:'retreatment-micro-kyiv-2026-11-29',   date:'29.11.2026', city:'Київ',             title:'Переліковування під мікроскопом', topic:'retreatment', speaker:'noienko',    template:'retreatmentMicro',   price:null, bpr:null, address:'', time:'', seats:null, includes:[] },
    { slug:'power-endo-if-2026-12-05',            date:'05.12.2026', city:'Івано-Франківськ', title:'Power Endo',                      topic:'powerEndo',   speaker:'fedak',      template:'powerEndo',          price:null, bpr:null, address:'', time:'', seats:null, includes:[] },
    { slug:'endo-vinnytsia-2026-12-12',           date:'12.12.2026', city:'Вінниця',          title:'Ендодонтія. Сучасні протоколи',   topic:'endo',        speaker:'noienko',    template:'primaryEndo',        price:null, bpr:null, address:'', time:'', seats:null, includes:[] },
    { slug:'complex-endo-vinnytsia-2026-12-13',   date:'13.12.2026', city:'Вінниця',          title:'Складна ендодонтія',              topic:'complexEndo', speaker:'noienko',    template:'complexEndo',        price:null, bpr:null, address:'', time:'', seats:null, includes:[] }
  ],
