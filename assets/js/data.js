...
window.VSEODENT_DATA = {
  ...
  viberGroups: {
    ...
    /* Складне ендо — групи «профі» по містах.
       Зберігаємо посилання в даних, але сайт НЕ робить автоматичний
       перехід після реєстрації: курсантів перевіряє команда вручну. */
    complexEndo: {
  ...
  faq: [
    ...
    { q: 'Коли місце на курсі вважається заброньованим?',
      a: 'Місце на курсі бронюється лише після внесення передоплати. Після заявки менеджер VSEODENT підтвердить наявність місця та надішле реквізити для оплати.' },
